...
public class Main extends Application {
    ...
    private void addAppToTray() {
        try {
            ...
            java.awt.MenuItem webItem = new java.awt.MenuItem("Open webpage");
            webItem.addActionListener(event -> Platform.runLater(this::showWebView));
    ...
    public void showWebView() {
        Stage stage = WebStage.getWebStage();
        stage.show();
    }
}